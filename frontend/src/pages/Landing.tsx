  ...
  return (
    <div className="-mt-6 w-full flex flex-col md:flex-row justify-center gap-12 items-center">
      <div className="w-3/4 md:w-1/2 order-2 md:order-1">
        ...
        <p className="font-orbit font-bold text-2xl mb-4">
          Explore culture worldwide{" "}
          <span className="underline text-bold">with dance!</span>
        </p>

        <a
          href="/explore"
          className="bg-gradient-1 w-fit px-4 py-3 text-xl font-orbit font-bold flex gap-x-4 items-center"
        >
          get started
          <FaLongArrowAltRight />
        </a>
